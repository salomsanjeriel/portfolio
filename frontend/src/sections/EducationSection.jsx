        ...
        {education.map((edu, index) => (
          <ScrollRevealItem key={index} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
            ...
            <div className="w-[calc(100%-2.5rem)] md:w-[calc(50%-1.5rem)] p-4 rounded-xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 shadow-sm group-hover:border-primary-300 dark:group-hover:border-primary-500/50 group-hover:shadow-[0_8px_30px_rgba(249,115,22,0.1)] dark:group-hover:shadow-[0_8px_30px_rgba(249,115,22,0.2)] transition-all duration-300">
              ...
              <div className="text-[10px] font-bold text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-white/5 px-3 py-1 rounded-full w-max border border-gray-200 dark:border-white/10 transition-colors">
                {edu.dates}
              </div>
            </div>
          </ScrollRevealItem>
